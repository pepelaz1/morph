...
namespace NGif
{
    public class AnimatedGifEncoder
    {
        ...
        protected BaseEffect effect = null; // effect 
         ...
         */
        public bool AddFrame(Dispatcher dispatcher, WriteableBitmap im)
        {
            if ((im == null) || !started)
            {
                return false;
